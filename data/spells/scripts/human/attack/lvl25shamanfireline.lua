...
function onCastSpell(cid, var)
	...
	addEvent(startPos,400,combat4_Brush_3,cid,var)
	addEvent(startPos,300,combat3_Brush_3,cid,var)
	addEvent(startPos,200,combat2_Brush_3,cid,var)
	addEvent(startPos,100,combat1_Brush_3,cid,var)
	startPos(combat0_Brush_3,cid,var)
	return true
end